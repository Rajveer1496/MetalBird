...
.section .text, "ax"
    ...
    .global reg_val_check
    .type reg_val_check, %function
    .thumb_func
        reg_val_check:
            @ Input:
                @ R0 = Register Addr
            ...
            @ Output:
                @ R0 = Actual value (0 if it was matched)
            ...
            MOV R3, R1 @ Save actual value

            EOR R1, R5 @ XOR -> this should set R1=0 if it was configured correctly with config
