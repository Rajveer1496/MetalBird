...
.section .text, "ax"
    .global Reset_Handler
        Reset_Handler:
            ...
            LDR R0, =(FLASH_INF_BASE + FLASH_ACR)
            LDR R1, [R0]
            ...
            @ SysTick setup (In CORTEX-M CPU CORE, Not in STM32)
            ...
            @ GPIOB CLOCK ENABLE
                ...
                @ GPIOBEN bit = 1
            LDR R0, =(RCC_BASE + RCC_AHB1ENR)     @LOAD this 32 bit address into R0 (RCC Base address + RCC_AHB1ENR offset)
